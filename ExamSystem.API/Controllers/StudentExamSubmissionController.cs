...
namespace ExamSystem.API.Controllers
{
    ...
    [ApiController]
    public class StudentExamSubmissionController : ControllerBase
    {
        private readonly IStudentExamSubmissionService _studentExamSubmissionService;

        public StudentExamSubmissionController(IStudentExamSubmissionService studentExamSubmissionService)
        {
